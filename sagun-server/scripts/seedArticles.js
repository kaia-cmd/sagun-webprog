...
const articles = [
  {
    ...
    image: '/images/articles/card1.jpg',
  },
  {
    ...
    image: '/images/articles/card2.jpg',
  },
  {
    ...
    image: '/images/articles/card3.jpg',
  },
  {
    ...
    image: '/images/articles/card4.jpg',
  },
  {
    ...
    image: '/images/articles/card5.jpg',
  },
  {
    ...
    image: '/images/articles/card6.jpg',
  },
  {
    ...
    image: '/images/articles/card7.jpg',
  },
  {
    ...
    image: '/images/articles/card8.jpg',
  },
  {
    ...
    image: '/images/articles/card9.jpg',
  },
  {
    ...
    image: '/images/articles/card10.jpg',
  },
];
...
async function run() {
  try {
    ...
    for (const article of articles) {
      const existing = await Article.findOne({ name: article.name });
      if (existing) {
        await Article.updateOne({ _id: existing._id }, { $set: article });
        updated += 1;
      } else {
    ...
    console.log(`Article seed completed. Inserted: ${inserted}, Updated: ${updated}`);
    process.exit(0);
  } catch (err) {
    console.error('Error seeding articles:', err.message || err);
    process.exit(1);
  }
}
